...
-- Daily at 03:00 UTC: drop message_authors rows older than 30 days
select cron.schedule('purge_message_authors',   '0 3 * * *', $$delete from public.message_authors where created_at < now() - interval '30 days';$$);
